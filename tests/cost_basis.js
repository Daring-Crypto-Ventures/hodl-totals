...
function test0_CostBasis() {
  QUnit.test( "test0 - Sample Dataset", function() {
    // create temp sheet
...
function test4_CostBasis() {
  QUnit.test( "test4 - Simple Partial Sale", function() {
    // create temp sheet
    var currentdate = new Date(); 
...
function test6_CostBasis() {
  QUnit.test( "test6 - Simple Term Split", function() {
    // create temp sheet
    var currentdate = new Date(); 
...
function test8_CostBasis() {
  QUnit.test( "test8 - Real Data with Term Split - Two Rounds", function() {
    // create temp sheet
    var currentdate = new Date(); 
