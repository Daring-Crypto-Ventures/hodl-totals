...
export function test1CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 3, 16, '2017-01-01', `Round ${round} Test1 : Row 4 Latest Date Acquired : expected 2017-01-01`);
...
export function test2CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 3, 16, '2017-01-01', `Round ${round} Test2 : Row 4 Latest Date Acquired : expected 2017-01-01`);
...
export function test3CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 4, 16, '2017-01-01', `Round ${round} Test3 : Row 5 Latest Date Acquired : expected 2017-01-01`);
            ...
            assertCell(sheet, data as string[][], 5, 16, '2018-01-01', `Round ${round} Test3 : Row 6 Latest Date Acquired : expected 2018-01-01`);
...
export function test5CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 4, 16, '2017-01-01', `Round ${round} Test5 : Row 5 Latest Date Acquired : expected 2017-01-01`);
            ...
            assertCell(sheet, data as string[][], 5, 16, '2017-01-01', `Round ${round} Test5 : Row 6 Latest Date Acquired : expected 2017-01-01`);
            ...
            assertCell(sheet, data as string[][], 6, 16, '2018-02-01', `Round ${round} Test5 : Row 7 Latest Date Acquired : expected 2018-02-01`);
            ...
            assertCell(sheet, data as string[][], 10, 16, '2018-02-01', `Round ${round} Test5 : Row 11 Latest Date Acquired : expected 2018-02-01`);
            ...
            assertCell(sheet, data as string[][], 11, 16, '2018-02-01', `Round ${round} Test5 : Row 12 Latest Date Acquired : expected 2018-02-01`);
            ...
            assertCell(sheet, data as string[][], 12, 16, '2018-02-01', `Round ${round} Test5 : Row 13 Latest Date Acquired : expected 2018-02-01`);
...
export function test6CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 27, 16, '2019-04-09', `Round ${round} Test6 : Row 28 Latest Date Acquired : expected 2019-04-09`);
            ...
            assertCell(sheet, data as string[][], 28, 16, '2020-04-08', `Round ${round} Test6 : Row 29 Latest Date Acquired : expected 2020-04-08`);
...
export function test7CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 12, 16, '2018-11-18', `Round ${round} Test7 : Row 28 Latest Date Acquired : expected 2018-11-18`);
...
export function test8CostBasis(): UnitTestWrapper {
    return (): void => {
        ...
        const testRun = function (round: number): void {
            ...
            assertCell(sheet, data as string[][], 3, 16, '2009-01-03', `Round ${round} Test8 : Row 4 Latest Date Acquired : expected 2009-01-03`);
            ...
            assertCell(sheet, data as string[][], 4, 16, '2009-01-03', `Round ${round} Test8 : Row 5 Latest Date Acquired : expected 2009-01-03`);
...
function callCalculateFIFO(sheet: GoogleAppsScript.Spreadsheet.Sheet | null, coinName: string, data: CompleteDataRow[], round = 1): [number, number, string][] {
    ...
    if (typeof ScriptApp === 'undefined') {
        ...
        // extract data needed for cost basis calc
        const dateValues = data.map(d => dateFromString(d[4]));
        const lotData = data.map(d => [d[8], d[9]] as [number, number]); // extract the lots as a 2D array
        const salesData = data.map(d => [d[10], d[11]] as [number, number]); // extract the lots as a 2D array

        // do the cost basis calc
        const lots = getOrderList(dateValues, lotData);
        const sales = getOrderList(dateValues, salesData);
