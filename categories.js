...
function newCategorySheet() {
  ...
  var initialData = [
    ...
    ['USD Withdrawl',   'Cash Out','Taxable',    '=IF(EXACT(B3,\"Inflow\"), A3, \"\")', '=IF(AND(EXACT(B3,\"Outflow\"),NOT(EXACT(A3,\"Traded\")),NOT(EXACT(A3,\"Tx Fee\"))), A3, \"\")'],
    ...
    ['Gift Received',   'Inflow',  'Taxable',    '=IF(EXACT(B8,\"Inflow\"), A8, \"\")', '=IF(AND(EXACT(B8,\"Outflow\"),NOT(EXACT(A8,\"Traded\")),NOT(EXACT(A8,\"Tx Fee\"))), A8, \"\")'],
    ...
    ['Staking',         'Inflow',  'Taxable',    '=IF(EXACT(B13,\"Inflow\"), A13, \"\")', '=IF(AND(EXACT(B13,\"Outflow\"),NOT(EXACT(A13,\"Traded\")),NOT(EXACT(A13,\"Tx Fee\"))), A13, \"\")'],
    ['Tip Income',      'Inflow',  'Not Taxable','=IF(EXACT(B14,\"Inflow\"), A14, \"\")', '=IF(AND(EXACT(B14,\"Outflow\"),NOT(EXACT(A14,\"Traded\")),NOT(EXACT(A14,\"Tx Fee\"))), A14, \"\")'],
    ['Lost/Stolen',     'Outflow', 'Taxable',    '=IF(EXACT(B15,\"Inflow\"), A15, \"\")', '=IF(AND(EXACT(B15,\"Outflow\"),NOT(EXACT(A15,\"Traded\")),NOT(EXACT(A15,\"Tx Fee\"))), A15, \"\")'],
    ['Given Away',      'Outflow', 'Not Taxable','=IF(EXACT(B16,\"Inflow\"), A16, \"\")', '=IF(AND(EXACT(B16,\"Outflow\"),NOT(EXACT(A16,\"Traded\")),NOT(EXACT(A16,\"Tx Fee\"))), A16, \"\")'],
    ['Project Ended',   'Outflow', 'Taxable',    '=IF(EXACT(B17,\"Inflow\"), A17, \"\")', '=IF(AND(EXACT(B17,\"Outflow\"),NOT(EXACT(A17,\"Traded\")),NOT(EXACT(A17,\"Tx Fee\"))), A17, \"\")'],
    ['Sold for Goods',  'Outflow', 'Taxable',    '=IF(EXACT(B18,\"Inflow\"), A18, \"\")', '=IF(AND(EXACT(B18,\"Outflow\"),NOT(EXACT(A18,\"Traded\")),NOT(EXACT(A18,\"Tx Fee\"))), A18, \"\")'],
    ['Spent',           'Outflow', 'Taxable',    '=IF(EXACT(B19,\"Inflow\"), A19, \"\")', '=IF(AND(EXACT(B19,\"Outflow\"),NOT(EXACT(A19,\"Traded\")),NOT(EXACT(A19,\"Tx Fee\"))), A19, \"\")'],
    ['Traded',          'Outflow', 'Taxable',    '=IF(EXACT(B20,\"Inflow\"), A20, \"\")', '=IF(AND(EXACT(B20,\"Outflow\"),NOT(EXACT(A20,\"Traded\")),NOT(EXACT(A20,\"Tx Fee\"))), A20, \"\")'],
    ['Tx Fee',          'Outflow', 'Taxable',    '=IF(EXACT(B21,\"Inflow\"), A21, \"\")', '=IF(AND(EXACT(B21,\"Outflow\"),NOT(EXACT(A21,\"Traded\")),NOT(EXACT(A21,\"Tx Fee\"))), A21, \"\")'],
   ];
