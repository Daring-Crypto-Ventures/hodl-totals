...
interface QUnitGAS extends QUnitStatic {
     ...
     *
     * The following internal functions and objects are exposed: init, reset, registerLoggingCallback, push, pushFailure, extend, is,
     * objectType, url, id, addEvent, triggerEvent, assert, ok, equal, notEqual, deepEqual, notDeepEqual, strictEqual, notStrictEqual,
     * propEqual notPropEqual, throws, raises, equals, same, equiv, jsDump, diff, htmlCollection, internals.
     *
     * Arguments:
     ...
     */
    exposeInternals(obj: QUnitGAS): QUnitGAS;
