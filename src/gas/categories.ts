...
export function newCategorySheet(): GoogleAppsScript.Spreadsheet.Sheet | null {
    ...
    const data = [
        ...
        ['NFT Sales Inflow', 'Inflow', 'Not Taxable'],
...
export function newNFTCategorySheet(): GoogleAppsScript.Spreadsheet.Sheet | null {
    ...
    const data = [
        ...
        ['Purchased (Fixed Price)', 'Inflow', 'Not Taxable'],
        ['Purchased (Auction)', 'Inflow', 'Not Taxable'],
        ['Purchased ($0 Price)', 'Inflow', 'Not Taxable'],
        ['Active Airdrop', 'Inflow', 'Taxable (on NFT Value)'],
        ['Created from Scratch', 'Inflow', 'Not Taxable'],
        ['Free Mint', 'Inflow', 'Not Taxable'],
        ['Gift Received', 'Inflow', 'Not Taxable'],
        ['Mint', 'Inflow', 'Not Taxable'],
        ['Passive Airdrop', 'Inflow', 'Not Taxable'],
    ...
    const justificationLinks = [
        ...
        ['NFT Purchases are not taxable from the HODL Totals perspective because the gain/loss on the crypto used to purchase NFTs are captured on the crypto coin\'s tracking sheet.', ''],
        ['$0 NFT Purchases are not taxable from the HODL Totals perspective because the gain/loss on the crypto spent on tx fees to acquire the NFT are captured on the crypto coin\'s tracking sheet.', ''],
        ...
        ['Minting NFTs are not taxable from the HODL Totals perspective because the gain/loss on the crypto spent on tx fees to acquire the NFTs are captured on the crypto coin\'s tracking sheet.', ''],
