...
function instructionData(): string[][] {
    const instructionsData: string[][] = [
        ...
        ['FALSE', '', '', 'Login to each wallet/account you have for this coin and enter balances into the "Balance" column the totals sheet.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'Enter today\'s date in the "on Date" column as the day you have reconciled that balance.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'Check that the reported balance matches the tracked coin balance.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'Optionally check the "Tx ✔" column for each reconciled row.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'THEN: CHECK YOUR FAIR MARKET VALUE', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'Make sure that the Value(USD) columns are populated correctly.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'If the USD value is not known, set a Valuation Strategy and fill in the Fair Market Value columns.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', 'After pasting many price values into the sheet, use "Update formulas" to fill in the Value(USD) columns.', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['FALSE', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
