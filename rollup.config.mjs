...
/*  START - functions from apps-script-typescript-rollup-starter subject to Apache 2.0 license */
/**
...
/*  END - functions from apps-script-typescript-rollup-starter subject to Apache 2.0 license */
...
export default [
    ...
    // Client-side bundles
    ...createHtmlBundleConfig('assets/*.html'),
    {
        input: [
            'src/gas/menu.ts'
